#include <iostream> //Adjacency List(Undirected and Weighted graph)::1↔2,1↔3,2↔4,2↔5,3↔5,4↔6,5↔6  (from destination weight)
#include <vector>
using namespace std;
...
void addEdge(vector<vector<Edge>>& adjacencyList, int from, int to, int weight) {
    ...
    // Since the graph is undirected, add edge from 'to' to 'from'
